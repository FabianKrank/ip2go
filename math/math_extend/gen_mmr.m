function output = gen_mmr(n,m,p,s1,s2)
...
if function_uses_structures
    funid = ['mmr_sid' num2str(s1.sid) '_sid' num2str(s2.sid) '_' num2str(n) '_' num2str(m) '_' num2str(p)];
else
    funid = ['mmr_' num2str(n) '_' num2str(m) '_' num2str(p)];
end
