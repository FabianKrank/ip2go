...
% no_k verarbeiten
if ~no_k
    varname = [varname num2str(index)];
end

if no_array
    varstr = ['static ' prec ' ' gendata.prefix varname ';'];
    elements = 1;
else
    varstr = ['static ' prec ' ' gendata.prefix varname '[' num2str(dim1*dim2) '];'];
    elements = dim1*dim2;
end
